...
interface ForthComingTitleProp {
  products?: Product[];
}

const ForthcomingTitle: React.FC<ForthComingTitleProp> = ({
  products = forthComingTitle
}) => {
  ...
  return (
    <section className="py-12 bg-gray-50 h-full w-screen max-w-none">
...
export default ForthcomingTitle;
