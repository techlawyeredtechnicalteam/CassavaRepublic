...
interface LatestTitleProps {
  products?: Product[];
}

const LatestTitle: React.FC<LatestTitleProps> = ({
  products = latestTitles
}) => {
  ...
  return (
    <section className="py-12 bg-gray-50 min-h-[38rem] w-screen max-w-none">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Latest Titles</h2>
        </div>
