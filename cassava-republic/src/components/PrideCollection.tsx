...
interface PrideCollectionProps {
  products?: Product[];
}

const PrideCollection: React.FC<PrideCollectionProps> = ({
  products = prideCollection
}) => {
    ...
    <section className="py-16 bg-gray-50 w-screen max-w-none">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Pride Collection</h2>
        </div>
...
export default PrideCollection;
